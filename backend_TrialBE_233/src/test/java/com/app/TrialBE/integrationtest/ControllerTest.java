...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM trialbe_242.FundingRound");
    jdbcTemplate.execute("DELETE FROM trialbe_242.Stage");
    jdbcTemplate.execute("DELETE FROM trialbe_242.Document");
    jdbcTemplate.execute("DELETE FROM trialbe_242.Investor");
    jdbcTemplate.execute("DELETE FROM trialbe_242.Founder");
    jdbcTemplate.execute("DELETE FROM trialbe_242.Startup");
     jdbcTemplate.execute("DELETE FROM trialbe_242.StartupFounders");
     jdbcTemplate.execute("DELETE FROM trialbe_242.StartupKeyMetrics");
     jdbcTemplate.execute("DELETE FROM trialbe_242.InvestorInvestmentPreferences");
     jdbcTemplate.execute("DELETE FROM trialbe_242.StartupPreviousRounds");
     jdbcTemplate.execute("DELETE FROM trialbe_242.FundingRoundInvestors");
